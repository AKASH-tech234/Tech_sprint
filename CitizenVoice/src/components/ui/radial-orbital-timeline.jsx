...
export default function RadialOrbitalTimeline({ timelineData }) {
  ...
  const getStatusStyles = (status) => {
    switch (status) {
      case "completed":
        return "text-white bg-rose-500 border-rose-500";
      case "in-progress":
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          {/* Center orb */}
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-rose-500 via-pink-500 to-violet-500 animate-pulse flex items-center justify-center z-10">
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  ${
                    isExpanded
                      ? "border-white shadow-lg shadow-rose-500/30"
                      : isRelated
                ...
                {/* Expanded card */}
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-black/90 backdrop-blur-lg border-white/30 shadow-xl shadow-rose-500/10 overflow-visible">
