  ...
  ({ text = "Button", className, ...props }, ref) => {
    return (
      ...
      >
        ...
        <div className="absolute left-[20%] top-[40%] h-2 w-2 scale-[1] rounded-full bg-white transition-all duration-300 group-hover:left-[0%] group-hover:top-[0%] group-hover:h-full group-hover:w-full group-hover:scale-[1.8] group-hover:bg-white"></div>
      </button>
    );
  }
);
